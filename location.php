...
function add_location(){
    ...
    $query = sprintf("INSERT INTO equip_mapping " .
        " (map_id, equip_id,name,lat,lng,date,unique_id,status,isVisible) " .
        " VALUES (NULL, '%s', '%s', '%s','%s', '%s', '%s','1','YES');",
...
select m.map_id, m.equip_id,m.name,m.lat,m.lng,m.date,m.unique_id,m.status as isconfirmed,e.name as emp,m.isVisible from equip_mapping m,employees e WHERE e.emp_id = m.emp_id and m.map_id ='".$_GET['id']."'");
